 ...
 * <p>
 * Used if the value of the field for which the custom annotation is used, is of type {@link Integer} <br>
 * <br>
...
public class ExistInCodeListValidatorForInteger extends
                                                AbstractExistInCodeListValidator<Integer> {
     ...
     */
    @Override
    protected String getCode(Integer value) {
